function changeMenuTablet() {
    ...
    document.getElementById('parallax').style.marginTop = '400px'
    document.getElementById('Title__Principal').style.marginTop = '30px'
    document.getElementById('projetos__paragrafo').style.marginTop = '100px'
    document.getElementById('botao__calculo').style.marginTop = '-85px'
